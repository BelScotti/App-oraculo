...
const showCarousel = () => {
    ...
    juegoTitulo.innerHTML = `<i class="fi fi-ts-sparkles"></i>Estas son las cartas que revelan el destino de ${player1} y ${player2} <i class="fi fi-ts-sparkles"></i>`
...
const verResultados = () => {
    ...
    cartasP1titulo.innerHTML = `<i class="fi fi-ts-sparkles"></i>Cartas de ${player1}<i class="fi fi-ts-sparkles"></i>`
    cartasP2titulo.innerHTML = `<i class="fi fi-ts-sparkles"></i>Cartas de ${player2}<i class="fi fi-ts-sparkles"></i>`
...
const guardarPartida = () => {
    ...
    const partidasGuardadasList = () => {
        ...
        partidasGuardadas.forEach((partida, index) => {
            ...
            y ${partida[0].player2} <button class="btnTiradas" onclick="verResultados(${index})">Ver</button></li>`       
        })
    }
